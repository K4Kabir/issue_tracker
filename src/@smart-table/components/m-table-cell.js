...
export default class MTableCell extends React.Component {
  getRenderValue() {
    ...
    if (this.props.columnDef.render) {
    ...
    } else if (this.props.columnDef.type === "bold") {
      ...
      if (
        ...
        return moment(this.props.value).format("hh:mm:ss a DD-MM-YYYY");
      }
      if (this.props.value instanceof Date) {
  ...
  getStyle = () => {
    ...
    let cellStyle = {
      ...
      //textAlign: 'center',
      // textAlign:
      //   /^[0-9\.\,\-\ \/]+$/.test(this.props.value) === true ? 'right' : 'left',
